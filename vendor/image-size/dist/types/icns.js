...
exports.ICNS = {
    ...
    calculate(input) {
        ...
        // CVE-2025-71330: an entry length below the 8-byte entry header size
        // (including 0) can never be valid and would stall the offset forever
        if (imageHeader[1] < SIZE_HEADER)
            throw new TypeError('Invalid ICNS, entry size is too small');
